...
void findJetToPin(std::vector<UsefulJet> jetVec, int nparams, int & ipin, double & cstart )
{
  ...
  double desiredMht = TMath::Max(30., TMath::Min(90.0, ht/3));// /3 worked better than /2 fyi, for HT300  
...
//constraintPhiName = "HardMetPhi";///this wasn't on for the working version
